...
import { Get_Decisions, Get_External_Factors, Get_reports } from '../wailsjs/go/main/App';
...
export const decisions: simulation.Decisions | empty = $state({})
export const external_factors: simulation.External_factors = $state(new simulation.External_factors)
export const latest_reports: simulation.Report | empty = $state({})
